...
alepherp.DBRecordDlgLineasServiciosDocumentosGestion = function() {
}

alepherp.DBRecordDlgLineasServiciosDocumentosGestion.prototype.init = function(ui) {
...
alepherp.DBRecordDlgLineasServiciosDocumentosGestion.prototype.validate = function() {
...
alepherp.DBRecordDlgLineasServiciosDocumentosGestion.prototype.beforeSave = function() {
   return true;
}

alepherp.DBRecordDlgLineasServiciosDocumentosGestion.prototype.beanSaved = function() {
   return;
}

alepherp.DBRecordDlgLineasServiciosDocumentosGestion.prototype.beforeNavigate = function() {
   return true;
}

alepherp.DBRecordDlgLineasServiciosDocumentosGestion.prototype.afterNavigate = function() {
    return;
}

alepherp.DBRecordDlgLineasServiciosDocumentosGestion.prototype.updateIVA = function() {
...
alepherp.DBRecordDlgLineasServiciosDocumentosGestion.prototype.updateIRPF = function() {
...
alepherp.DBRecordDlgLineasServiciosDocumentosGestion.prototype.incluirrecargoequivalenciaValueModified = function() {
    thisForm.db_recargo.visible = thisForm.db_incluirrecargoequivalencia.checked;
}

alepherp.DBRecordDlgLineasServiciosDocumentosGestion.prototype.generamovimientosstockValueModified = function() {
    if ( this.ui.findChild("gbAlmacen") != null ) {
        this.ui.findChild("gbAlmacen").visible = bean.generamovimientosstock.value;
    }
}

alepherp.DBRecordDlgLineasServiciosDocumentosGestion.prototype.idservicioValueModified = function() {
...
alepherp.DBRecordDlgLineasServiciosDocumentosGestion.prototype.idarticuloValueModified = function() {
...
alepherp.DBRecordDlgLineasServiciosDocumentosGestion.prototype.idinstanciaValueModified = function() {
...
alepherp.DBRecordDlgLineasServiciosDocumentosGestion.prototype.updateLabels = function() {
...
alepherp.DBRecordDlgLineasServiciosDocumentosGestion.prototype.establecerEstadoWidgetsAlmacen = function() {
